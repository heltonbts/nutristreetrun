import { Path, Rect, Svg, Circle } from 'react-native-svg';
    ...
    case 'feed':
      return (
        <Svg width={22} height={22} viewBox="0 0 22 22" fill="none">
          ...
          <Path d="M2 19c0-3 2.5-5 5.5-5s5.5 2 5.5 5M12.5 14c0-2 2-3.5 4-3.5s3.5 1.5 3.5 3.5"
    ...
    case 'profile':
      return (
        <Svg width={22} height={22} viewBox="0 0 22 22" fill="none">
          ...
          <Path d="M3.5 19c0-4 3.5-6.5 7.5-6.5s7.5 2.5 7.5 6.5"
            stroke={color} strokeWidth={1.8} strokeLinecap="round" />
        </Svg>
      );
  }
